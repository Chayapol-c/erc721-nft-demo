"""Helpful scripts for deploy and create an NFT."""
...
def get_breed(breed_number):
    """Return the dog breeding by given breed_number."""
    return BREED_MAPPING[breed_number]


def get_account(index=None, id=None):
    """Return an address of accounts."""
    if index:
...
def fund_with_link(
    ...
    """
    This function will either:
        - call get_account() if there's no accout as param.
        - transfer LINK token to the address.
    Args:
        contract_address(string): This is a contract address that will be funded.
        account(string): This is a funder contract.
        amount(int): This is a LINK amount that will be funded.
    Returns:
